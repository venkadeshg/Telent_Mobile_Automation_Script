Feature: AuditInprogressform

Validation of Audit In Progress form

@Regression
Scenario: Inprogress Form
	...
	And Select Audit type in Inprogress
	And Click on the Primary audit type
	 And select the Cable in primary Type
